...
if (isset($_POST['recentbtn'])) {
  ...
  $database->updateprecent($id, $title, $img);
}
?>
        ...
        <div class="modal-dialog w-100 p-1 ">
          <div class="modal-content ">
            ...
            <div class="col mx-auto mb-1">
              ...
              <button type="submit" class="btn btn4 text-dark fw-bold shadow-md" name="recentbtn">Update</button>
            </div>
          </div>
